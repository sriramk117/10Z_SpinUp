...
rotation RotationTilter = rotation(PORT13, false);
distance DistanceFront = distance(PORT21);
/*vex-vision-config:begin*/
signature vision_sensor__GOAL_BLUE = signature (1, -1, 151, 75, -4553, -3821, -4187, 3, 0);
signature vision_sensor__GOAL_RED = signature (2, -2935, -2581, -2758, 8247, 8705, 8476, 3, 0);
signature vision_sensor__MOGORED = signature (3, 6431, 6843, 6637, 301, 527, 414, 2.5, 0);
vision vision_sensor = vision (PORT20, 50, vision_sensor__GOAL_BLUE, vision_sensor__GOAL_RED, vision_sensor__MOGORED);
