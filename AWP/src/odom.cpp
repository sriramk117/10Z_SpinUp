...
void odom::turnTo(double desiredHeading, double cap) {
  ...
  double a_error =  correctAngle(desiredHeading - (Gyro.heading(degrees))); //desiredHeading - (360 - Gyro.heading(degrees))//odom::a - desiredHeading;
  while(abs(a_error) > 2) {
    ...
    a_error = correctAngle(desiredHeading - (Gyro.heading(degrees)));//odom::a - desiredHeading;
