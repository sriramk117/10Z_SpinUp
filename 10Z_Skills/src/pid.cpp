...
double pid::axial(double dy, double pidCap) {
  ...
  //Settings for PID
  axial_kP = 0.55;//0.4 //0.25;//0.215 //0.23;//0.25;  //0.2//0.215
  //axial_kI = 0.000009;//0.00001;//.001;
  axial_kD = 0.52;//0.37 //0.2  //0.15
...
double pid::gyroPid (double phi) {
   ...
   turn_kP = 3.4;//2.4;//2;//0.94;//2;//0.85;//0.9;
   //turn_kI = 0.00025;//0.0003//0.0001;//0.0001;
   turn_kD = 3;//2;//1.7 //0.4;//0.12;//0.15 //0.81; //1    
   //double vel = 0;
   //int badnums = 0;
   t_error = phi;
