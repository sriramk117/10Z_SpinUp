...
class odom {
  ...
  static void moveTo(double target_x, double target_y, double dir, double tolD, double tolA, double capD, double capA, double settleTime); //change parameters
  ...
  static void turnTo(double desiredHeading, double cap); //CHANGE IF NOT NEEDED TO REMOVE CAP
  ...
  static void reverseTurn(double desiredHeading, double cap);
  static void moveForwardPIDDistance(double cap);
